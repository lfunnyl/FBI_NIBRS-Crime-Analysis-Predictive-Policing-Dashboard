...
WITH Agency_Stats AS (
    ...
    SELECT
        ...
        rs.state_name, -- DÜZELTME: Eyalet ismi 'rs' tablosundan geliyor
        ...
        -- En Sık İşlenen Suç (Dominant Crime)
    ...
    -- EKSİK OLAN BAĞLANTI EKLENDİ: Eyalet İsimleri
    ...
    *,
    ...
    CASE 
        ...
        WHEN (total_incidents / total_officers) > 50 AND (violent_crimes / total_incidents) > 0.3 
            ...
            THEN "🚨 KIRMIZI ALARM: Taktik Ekip & Ek Personel Gönder"

            

        WHEN (total_incidents / total_officers) > 50 

            THEN "⚠️ Personel Yetersiz: İdari Destek / Atama
